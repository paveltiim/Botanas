...
namespace Aires.Pantallas
{
    public partial class Empresas: FormBase
    {
        ...
        void AgregaEmpresa(int TipoPersonaId, string Nombre, string NombreFiscal, string RegimenFiscal, string Direccion, string Calle, string NoExterior, string NoInterior, string Colonia,
        ...
        void ActualizaEmpresa(int EmpresaId, int TipoPersonaId, string Nombre, string NombreFiscal, string RegimenFiscal, string Direccion, string Calle, string NoExterior, string NoInterior, string Colonia,
            string Localidad, string Municipio, string Estado, string CP, string Telefono, string Telefono2, string RFC, string Email, string Banco, string NumeroCuenta,
            string Sucursal, string CLABE, string NumeroReferencia, string Certificado, string Key, string Clave, int TipoTasaIVAId, string NoCertificado)
        {
            EntEmpresa empresa = new EntEmpresa()
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!VerificaTextosIguales(txtClave.Text, txtConfirmaClave.Text))
                {
                    ...
                    AgregaEmpresa(cmbTipoPersona.SelectedIndex + 1, txtNombre.Text, txtNombreFiscal.Text, txtRegimenFiscal.Text, txtDireccion.Text, txtCalle.Text, txtNoExterior.Text, txtNoInterior.Text, txtColonia.Text, txtLocalidad.Text, txtMunicipio.Text, txtEstado.Text, txtCP.Text, txtTelefono.Text, txtTelefono2.Text, txtRFC.Text, txtEmail.Text, txtBanco.Text, txtNoCuenta.Text, txtSucursal.Text, txtCLABE.Text, txtNoReferencia.Text, txtCertificado.Text, txtKey.Text, txtClave.Text, cmbTipoTasaIVA.SelectedIndex + 1, txtNoCertificado.Text);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!VerificaTextosIguales(txtClave.Text, txtConfirmaClave.Text))
                {
                    ...
                    ActualizaEmpresa(EmpresaSeleccionada.Id, cmbTipoPersona.SelectedIndex + 1, txtNombre.Text, txtNombreFiscal.Text, txtRegimenFiscal.Text, txtDireccion.Text, txtCalle.Text, txtNoExterior.Text, txtNoInterior.Text, txtColonia.Text, txtLocalidad.Text, txtMunicipio.Text, txtEstado.Text, txtCP.Text, txtTelefono.Text, txtTelefono2.Text, txtRFC.Text, txtEmail.Text, txtBanco.Text, txtNoCuenta.Text, txtSucursal.Text, txtCLABE.Text, txtNoReferencia.Text, txtCertificado.Text, txtKey.Text, txtClave.Text, cmbTipoTasaIVA.SelectedIndex + 1, txtNoCertificado.Text);
