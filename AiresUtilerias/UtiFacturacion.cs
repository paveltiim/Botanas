...
namespace AiresUtilerias
{
    public class UtiFacturacion
    {
                                ...
                                string Observaciones)
        {
            ...
            st.WriteLine("logotipo|lg_de198d9f5c5960f7ac72e6f"); //lg_de198d9f5c5960f7ac72e6f - Serdan // lg_27cb5900e159233c421067e - GREE
            ...
            ////if (Pedido.TotalSinRetenciones != (Pedido.Total - cantidadISR - cantidadIvaRetenido))
            //if (Pedido.Total!= (Pedido.Total - ISRRetenido - IVARetenido))
            //    throw new Exception("REVISAR RETENCIONES");
        ...
        public string FacturarNotaCredito(EntEmpresa Emisor, decimal Total, string Descripcion, string FolioFactura, EntCliente Cliente, 
                                            DateTime FechaFactura, string FormaPago, string MedioPago, string CondicionPago, string NumeroCuenta, 
...

        {
            ...
            st.WriteLine("logotipo|lg_de198d9f5c5960f7ac72e6f"); // lg_de198d9f5c5960f7ac72e6f - Serdan
                                                       ...
                                                       string PathGuardaArchivos)
        {
            ...
            st.WriteLine("Nombre=" + Emisor.NombreLegal);
            st.WriteLine("RegimenFiscal=" + Emisor.RegimenFiscalId);
