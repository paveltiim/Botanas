...
namespace AiresUtilerias
{
    public class UtiFacturacion
    {
        ...
        string Contraseña = "tiimFac10!";//TIIM
                                    ...
                                    string UsoCFDI, string PathGuardaArchivos)
        {
            ...
            string textoCSV = @"CFDI|4.0|" + SerieFactura + "|" + FolioFactura + "|" + FechaFactura.ToString("yyyy-MM-ddTHH:mm:ss") + "||" + FormaPago + "|" +
                                "|" +
                                "|" + CondicionPago + "" +
            ...
            string[] opciones = new string[6] { "PLUGIN_PROCESO:GENERICO_CFDI40:1.0", 
                "CALCULAR_SELLO", "ESTABLECER_NO_CERTIFICADO",
            ...
            try
            {
                ...
                try
                {
                    pdfBase64 = respuesta.Remove(0, respuesta.IndexOf("<pdfBase64>")).Remove(respuesta.Remove(0, respuesta.IndexOf("<pdfBase64>")).IndexOf("</pdfBase64>")).Replace("<pdfBase64>", "");
                ...
                {
                    throw new Exception("FACTURA TIMBRADA \nERROR EN GUARDADO DE PDF");
                }
            }
            catch (Exception ex)
            {
                                                ...
                                                string PathGuardaArchivos)
        {
            ...
            // Aquí declaramos el CSV que queremos timbrar (sólo se permite un comprobante por transacción)
            string textoCSV = @"CFDI|4.0|CP|" + FolioComplemento + "|" + FechaComplemento.ToString("yyyy-MM-ddTHH:mm:ss") +
                                               ...
                                               string Observaciones)
        {
            ...
            if (Emisor.NumeroReferencia != "ca2be778-3ba5-48f3-8fae-00b831faebea" && !string.IsNullOrWhiteSpace(Emisor.NumeroReferencia))//TIIM
            {
                this.Contrato = Emisor.NumeroReferencia;
                this.Contraseña = Emisor.CLABE; //this.Contraseña = "Fuckoo06!";
            }
            ...
            //prueba = true;
            //this.Contraseña= "Fuckoo06!";
            string respuesta = wPade.procesarArchivo(this.Contrato, this.Usuario, this.Contraseña, prueba, textoCSV, opciones);
            string uuid = "";
