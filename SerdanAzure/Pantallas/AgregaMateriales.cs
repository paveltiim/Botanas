...
{
    public partial class AgregaMateriales : FormBase
    {
        List<AiresEntidades.EntProducto> ListaProductosDetalle;
        public AgregaMateriales(List<AiresEntidades.EntProducto> ProductosDetalle)
        {
            InitializeComponent();
        ...
        private void txtFiltroSerie_TextChanged(object sender, EventArgs e)
        {
            ...
            gvProductosDetalle.DataSource = ListaProductosDetalle.Where(P => P.Serie.ToUpper().Contains(txtPrecioCosto.Text.ToUpper())).ToList();
        }
