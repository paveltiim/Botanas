...
namespace Aires.Pantallas
{
    ...
    {
        public EstadoDeCuenta(EntCliente Cliente)
        {
            InitializeComponent();
        ...
        public void CargaGvPedidosClientesCredito(int ClienteId)
        {
            ...
            ListaPedidos = new BusPedidos().ObtienePedidosClientesDeuda(Program.EmpresaSeleccionada.Id).Where(P => P.ClienteId == ClienteId).ToList();
            ...
            ReportParameter parm1 = new ReportParameter("Cliente", cliente.NombreFiscal);
            ReportParameter parm2 = new ReportParameter("Fecha", DateTime.Today.ToShortDateString());
