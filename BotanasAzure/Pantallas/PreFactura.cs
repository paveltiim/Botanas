            ...
            try
            {
                ...
                if (facturado)
                {
                    ...
                    try
                    {
                        ...
                        modiPDF.ModificaPDF(pagare, pagare, pagare, rutaArchivoPDF, "1",this.ListaProductosSeleccionados.Count);
                        ...
                        if (Program.UsuarioSeleccionado.Id == 1)
                        {
                            try
                            {
                                string pathClienteDirectorioCopia = PathPreFacturas + "\\" + ClienteSeleccionado.Nombre;
