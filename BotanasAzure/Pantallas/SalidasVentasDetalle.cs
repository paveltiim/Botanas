...
{
    public partial class SalidasVentasDetalle : FormBase
    {
        ...
        void AgregaProductoEnPedido(EntProducto ProductoSeleccionado, decimal CantidadAgrega)
        {
            ...
            if (CantidadAgrega > 0)
            {
                ...
                //PRECIO A DETALLE
                List<EntProducto> precios = new BusProductos().ObtieneListaPreciosProducto(0, productoPrecio.Id);
                //listaProductos.Add(new EntProducto() { Id = 11, Descripcion = "DETALLE", PrecioVenta = precios.First().PrecioEspecial5 });
                ProductoSeleccionado.PrecioVentaSinIVA = precios.First().PrecioEspecialDetalle; //DETALLE
                ...
                {
                    ProductoSeleccionado.IEPS = Math.Round(ProductoSeleccionado.PrecioVentaSinIVA * 1.08m, 2) - ProductoSeleccionado.PrecioVentaSinIVA;
                }
...
#region EMPRESAS
        ...
        void CargaAlmacenes(int AlmacenId)
        {
        ...
        /// <returns></returns>
        public int AgregarPagoPedido(int AlmacenCajaId, int PedidoId, decimal Cantidad, int FormaPagoId, string FormaPago, DateTime FechaPago)
        {
        ...
        private void Ventas_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                CargaAlmacenes(22);//Punto Venta Detallle (NUEVO)
                //CargaTipoSalidas();
                CargaClientes();
                //}
            }
