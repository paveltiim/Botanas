...
namespace Aires.Pantallas
{
    public partial class MuestraProductosDetalle : FormBase
    {
        ...
        {
            string rutaGuardaArchivosOrden = base.RutaImpresion +"\\"+ PedidoConsignacion.Cliente + "\\" + PedidoConsignacion.NumOrden;
            base.VerificaRutas(base.RutaImpresion , PedidoConsignacion.Cliente + "\\" + PedidoConsignacion.NumOrden);
                ...
                if (vSeleccionaEmp.ShowDialog() == DialogResult.OK)
                {
                    ...
                    if (vClientes.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        foreach (EntProducto p in productosSeleccionados)
                        {
                            ...
                            vProductos.AumentaProducto(p.ProductoId, -p.Cantidad);
                        }
