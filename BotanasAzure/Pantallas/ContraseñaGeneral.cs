...
{
    public partial class ContraseñaGeneral : Form
    {
        public ContraseñaGeneral(string Usuario, string Contraseña)
        {
            InitializeComponent();
            this.Usuarios = new List<EntUsuario>();
        ...
        public ContraseñaGeneral(bool AdminDefault)
        {
            InitializeComponent();
            this.Usuarios = new List<EntUsuario>();
            //this.Usuario = new EntUsuario() { Usuario = "cheli".ToUpper(), Contraseña = "ch3l1" };

            Usuarios.Add(new EntUsuario() { Usuario = "cheli".ToUpper(), Contraseña = "ch3l1" });
        }
